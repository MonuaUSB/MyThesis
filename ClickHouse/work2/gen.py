...
def load_data():
    ...
    client.execute("TRUNCATE TABLE ssb2.part")
    client.execute("TRUNCATE TABLE ssb2.dates")
    client.execute("TRUNCATE TABLE ssb2.supplier")
    client.execute("TRUNCATE TABLE ssb2.customer")
    client.execute("TRUNCATE TABLE ssb2.lineorder")
    ...
    load_table(os.path.join(SSB_DATA_DIR, "part.tbl"), "ssb2.part",
    ...
    load_table(os.path.join(SSB_DATA_DIR, "date.tbl"), "ssb2.dates",
    ...
    load_table(os.path.join(SSB_DATA_DIR, "supplier.tbl"), "ssb2.supplier",
    ...
    load_table(os.path.join(SSB_DATA_DIR, "customer.tbl"), "ssb2.customer",
    ...
    load_table(os.path.join(SSB_DATA_DIR, "lineorder.tbl"), "ssb2.lineorder",
