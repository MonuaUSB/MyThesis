...
def create_tables():
    ...
    create_part_table = """
    CREATE TABLE IF NOT EXISTS ssb2.part (
      p_partkey Int32,
      p_name String,
      p_mfgr String,
      p_category String,
    ...
    create_dates_table = """
    CREATE TABLE IF NOT EXISTS ssb2.dates (
      d_datekey Int32,
      d_date String,
      d_dayofweek String,
      d_month String,
    ...
    CREATE TABLE IF NOT EXISTS ssb2.supplier (
      s_suppkey Int32,
      s_name String,
      s_address String,
      s_city String,
    ...
    CREATE TABLE IF NOT EXISTS ssb2.customer (
      c_custkey Int32,
      c_name String,
      c_address String,
      c_city String,
    ...
    CREATE TABLE IF NOT EXISTS ssb2.lineorder (
      lo_orderkey Int32,
      lo_linenumber Int32,
      lo_custkey Int32,
      lo_partkey Int32,
