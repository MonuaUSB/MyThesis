...
DB_CONFIG = {
    'host': '127.0.0.1',
    'user': 'root',  # CockroachDB по умолчанию использует пользователя root
    'password': '',
    'dbname': 'ssb',
    'port': '26257'
}
...
def execute_query(cursor, query):
    ...
    try:
        ...
        rows = cursor.fetchall()  # Ensure all results are read
...
def run_queries():
    ...
    for q in QUERIES:
        ...
        exec_time, rows = execute_query(cursor, q['sql'])
