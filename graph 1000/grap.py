...
beautify_plot(ax, 'Сравнение производительности СУБД', 'Название запроса', 'Время выполнения (с)')
...
# Настройка внешнего вида графика
beautify_plot(ax, 'Среднее использование CPU', 'Название запроса', 'CPU (%)')
...
# Настройка внешнего вида графика
beautify_plot(ax, 'Среднее использование памяти', 'Название запроса', 'Память (%)')
